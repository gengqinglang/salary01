...
const GudingZhuanFudongPage: React.FC = () => {
  ...
  return (
    <div>
      ...
      <div className="sticky top-0 bg-white border-b border-gray-100 z-10 py-2 flex items-center space-x-3">
        ...
        <h1 className="text-lg font-semibold text-foreground">固定转浮动</h1>
      </div>
      ...
      <div className="mt-8 p-4">
        <p className="text-gray-600 text-center">固定转浮动专属功能区域</p>
      </div>
    </div>
  );
};

export default GudingZhuanFudongPage;