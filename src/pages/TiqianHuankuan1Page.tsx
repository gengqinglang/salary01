...
import FinancialConfigurationFlow from '@/components/financial-status/FinancialConfigurationFlow';
      ...
      <div className="relative flex flex-col bg-white/90 backdrop-blur-xl flex-1">
        ...
        <div className="px-3 mt-3">
          ...
          <div className="text-left mb-4">
            <p className="text-base text-gray-700 font-medium">支持以下债务的提前还款试算，请选择：</p>
          </div>
...
export default TiqianHuankuan1Page;